...
/*
 Класс, содержащий методы поиска элементов в массиве сотрудников
 */
public class Main {
    /*
     Метод, выполняющий последовательный поиск в массиве Employee
     @param arr Массив сотрудников
    @param key Ключ для поиска
    @return Сотрудник, найденный по ключу, или null, если сотрудник не найден
     */
    ...
    /**
     Метод, выполняющий бинарный поиск в отсортированном массиве сотрудников
      @param arr Массив сотрудников
     @param key Ключ для поиска
     @return Сотрудник, найденный по ключу
     */
    ...
    /**
     Метод, выполняющий  поиск Фиббоначи в отсортированном массиве сотрудников
     @param arr Массив сотрудников
     @param key Ключ для поиска
     @return Сотрудник, найденный по ключу
     */
    ...
    /** Это метод main который считывает информацию о сотрудниках из файла. Он создает массив объектов Employee,
     сортирует массив и выполняет последовательный поиск, интерполяционный поиск и поиск Фибоначчи.
     Метод отображает результат * каждого поиска и время, затраченное на каждый поиск.*/
...
// Объявляем и инициализируем переменные
        ...
        //считывает информацию о сотрудниках с файла
        try {
        ...
        //Вывести не отсортированный список
        ...
        Arrays.sort(productionworkers); // Сортируем массив
        ...
        // Выполнить последовательный поиск и отобразить результат
        ...
        // Выполнить бинарный поиск и отобразить результат
        ...
        // Выполнить поиск Фиббоначи и отобразить результат
        startTime = System.nanoTime();
